...
if (isset($_GET['delete']) && isset($_GET['confirm']) && $_GET['confirm'] === 'yes') {
    if (!isAdmin()) {
        ...
        if ($result['status']) {
            echo '<script>setTimeout(function(){ window.location.href = "minutes.php"; }, 1000);</script>';
        }
    }
}

$search = trim($_GET['search'] ?? '');
$documents = getDocumentsByType($conn, 'minutes', $search);
        ...
        <div class="container-xl">
            <div class="page-header-content">
                <div class="page-header-text">
                    <h1 class="page-title">Documents - Minutes</h1>
                    <p class="page-subtitle">View uploaded meeting minutes documents</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <form method="GET" class="search-form">
                <div class="search-input-group">
                    <div class="form-group" style="flex: 1;">
                        <label for="search" class="form-label sr-only">Search Minutes</label>
                    ...
                    <div class="search-results-info">
                        <small class="text-muted">
                            ...
                            <a href="minutes.php" class="btn-link ms-2">Clear</a>
                        </small>
                    </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="container-xl">
            ...
            <div class="modal-overlay" id="deleteModal" style="display: flex !important;">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button class="modal-close" onclick="window.location='minutes.php'">×</button>
                    </div>
            ...
            <div class="dashboard-card">
                <div class="card-header-custom">
                    <div>
                        <h3 class="card-title">Minutes Documents</h3>
                ...
                <div class="card-body-custom">
                    ...
                    <div class="empty-state">
                        ...
                        <h3 class="empty-title">No Minutes Found</h3>
                        <p class="empty-text">Minutes will appear here once uploaded.</p>
