        ...
        <form action="" method="POST" class="space-y-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div class="space-y-2">
                    ...
                    <input type="text" name="cawangan_name" value="<?php echo htmlspecialchars($cawangan['cawangan_name']); ?>" required class="w-full px-6 py-4 bg-slate-50 border-b-2 border-slate-100 focus:border-kebana-blue focus:bg-white outline-none text-sm font-bold transition-all">
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="cawangan_code" value="<?php echo htmlspecialchars($cawangan['cawangan_code']); ?>" required class="w-full px-6 py-4 bg-slate-50 border-b-2 border-slate-100 focus:border-kebana-blue focus:bg-white outline-none text-sm font-bold transition-all">
                </div>
            </div>

            <div class="space-y-2">
                <label class="flex items-center space-x-3 cursor-pointer">
                    <input type="checkbox" name="is_active" value="1" <?php echo $cawangan['is_active'] ? 'checked' : ''; ?> class="w-4 h-4 text-kebana-blue focus:ring-kebana-blue border-slate-300 rounded">
                    <span class="text-xs font-black text-kebana-blue uppercase tracking-widest">Cawangan Aktif</span>
                </label>
                <p class="text-[9px] text-slate-400 font-bold italic mt-2">Nyahaktifkan cawangan untuk menyembunyikannya daripada pilihan pendaftaran baru.</p>
            </div>
