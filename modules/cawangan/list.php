<?php
/**
 * KEBANA Management System - Cawangan List
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50 border-b-2 border-slate-100">
                        <th class="px-8 py-5 text-[10px] font-black text-kebana-blue uppercase tracking-[0.2em]">KOD</th>
                        <th class="px-8 py-5 text-[10px] font-black text-kebana-blue uppercase tracking-[0.2em]">NAMA CAWANGAN</th>
                        <th class="px-8 py-5 text-[10px] font-black text-kebana-blue uppercase tracking-[0.2em]">STATUS</th>
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr>
                        <td colspan="5" class="px-8 py-24 text-center">
                            <i class="fa-solid fa-building-circle-exclamation text-5xl text-slate-100 mb-6 block"></i>
                            <p class="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">Tiada Rekod Cawangan Ditemui</p>
                        </td>
                    </tr>
                    <?php else: ?>
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        <td class="px-8 py-6">
                            <span class="inline-block px-3 py-1 bg-slate-100 text-kebana-blue text-[10px] font-black uppercase tracking-widest border border-slate-200">
                                <?php echo htmlspecialchars($c['cawangan_code'] ?: 'N/A'); ?>
                            </span>
                        </td>
                        <td class="px-8 py-6">
                            <p class="text-sm font-black text-kebana-blue uppercase tracking-tight"><?php echo htmlspecialchars($c['cawangan_name']); ?></p>
                        </td>
                        <td class="px-8 py-6">
                            <?php if ($c['is_active']): ?>
