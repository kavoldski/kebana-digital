...
<div class="space-y-12">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 border-t-8 border-kebana-blue shadow-sm">
        <div>
            ...
            <p class="text-xs font-black text-slate-500 uppercase tracking-widest mt-2">Urus maklumat akaun dan akses pengguna.</p>
        </div>
        <div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div class="bg-white border-t-8 border-kebana-blue shadow-sm p-10 space-y-10">
            <h3 class="text-sm font-black text-kebana-blue uppercase tracking-[0.2em] border-b border-slate-200 pb-4">Maklumat Asas</h3>
            ...
            <form action="" method="POST" class="space-y-8">
                <div class="grid grid-cols-1 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="email" name="email" value="<?php echo htmlspecialchars($user['email']); ?>" required class="w-full px-6 py-4 bg-slate-50 border-b-2 border-slate-200 focus:border-kebana-blue focus:bg-white outline-none text-sm font-bold transition-all">
                    </div>
                ...
                <button type="submit" name="update_info" class="w-full bg-kebana-blue text-white py-5 text-sm font-black uppercase tracking-[0.2em] hover:bg-kebana-accent transition-all shadow-xl">
                    KEMASKINI MAKLUMAT
                </button>
            </form>
        </div>
        ...
        <div class="bg-white border-t-8 border-kebana-yellow shadow-sm p-10 space-y-10">
            <h3 class="text-sm font-black text-kebana-blue uppercase tracking-[0.2em] border-b border-slate-200 pb-4">Set Semula Kata Laluan</h3>
            
            <form action="" method="POST" class="space-y-8">
                <div class="space-y-2">
                    <label class="text-xs font-black text-slate-500 uppercase tracking-widest">Kata Laluan Baru</label>
                    <input type="password" name="new_password" required class="w-full px-6 py-4 bg-slate-50 border-b-2 border-slate-200 focus:border-kebana-blue focus:bg-white outline-none text-sm font-bold transition-all">
                </div>

                <div class="space-y-2">
                    <label class="text-xs font-black text-slate-500 uppercase tracking-widest">Sahkan Kata Laluan</label>
                    <input type="password" name="confirm_password" required class="w-full px-6 py-4 bg-slate-50 border-b-2 border-slate-200 focus:border-kebana-blue focus:bg-white outline-none text-sm font-bold transition-all">
                </div>

                <div class="p-6 bg-amber-50 border-l-4 border-amber-500 text-xs font-bold text-amber-800 uppercase tracking-tight leading-relaxed">
                ...
                <button type="submit" name="reset_password" class="w-full bg-kebana-yellow text-kebana-blue py-5 text-sm font-black uppercase tracking-[0.2em] hover:bg-yellow-400 transition-all shadow-xl">
